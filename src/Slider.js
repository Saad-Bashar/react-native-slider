...
import { Animated, Image, StyleSheet, PanResponder, View, Text, Easing, ViewPropTypes } from 'react-native';
...
export default class Slider extends PureComponent {
  ...
  _renderThumbText = () => {
    var { thumbText, thumbTextStyle, slidingStart } = this.props;
